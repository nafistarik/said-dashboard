    ...
    <div className="p-6 px-10 space-y-6 bg-[#F6F6F6] min-h-screen">
      <div className="flex flex-col md:flex-row items-start md:items-center justify-start md:justify-between gap-4">
        <div className="space-y-3">
          <h1 className="text-3xl font-semibold">Supplier List</h1>
          <p className="text-sm text-gentle">View, manage Supplier List.</p>
        </div>
        {/* 
              ...
              <TableRow key={supplier.id}>
                ...
                <TableCell>
                  <Button variant="ghost" size="icon">
                    <Link href="/dashboard/supplier/1"><NotebookText /></Link>
                  </Button>
                </TableCell>
              </TableRow>
            ))}
